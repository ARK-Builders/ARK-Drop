...
class TransferHistoryItemLocalDataSource(
    ...
    suspend fun add(item: TransferHistoryItem): Long = dao.insert(item.toEntity())
...
fun TransferHistoryItemEntity.toDomain() =
    TransferHistoryItem(
        id = id,
        fileName = fileName,
        fileSize = fileSize,
...
fun TransferHistoryItem.toEntity() =
    TransferHistoryItemEntity(
        id = id,
        fileName = fileName,
        fileSize = fileSize,
        type = type,
